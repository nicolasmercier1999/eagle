...
import RV1.settings as settings
...
class User(models.Model):
    ...
    usr_birth_date = models.DateField()
...
class Chapter(models.Model):
	mdl = models.ForeignKey(Module, on_delete = models.CASCADE)
	chp_id = models.IntegerField()
	chp_title = models.CharField(max_length = 50)

class Course(models.Model):
	mdl = models.ForeignKey(Module, on_delete = models.CASCADE) 
	chp = models.ForeignKey(Chapter, on_delete = models.CASCADE)
	...
	crs_content = models.CharField(max_length = 100000)
...
class Document(models.Model):
	...
	dct = models.ForeignKey(Document_Type, on_delete = models.CASCADE)
...
class Share_File(models.Model):
	dcm = models.ForeignKey(Document, on_delete = models.CASCADE)
	usr = models.ForeignKey(User, on_delete = models.CASCADE)
	prt = models.ForeignKey(Permission_Type, on_delete = models.CASCADE)
